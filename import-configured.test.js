...
it('applies configuration with `@import`', () => {
    const noConfiguration = compileSassFile(`import.scss`);
    const withConfiguration = compileSassFile(`import-configured.scss`)

    expect(createPatch('import', noConfiguration, withConfiguration)).toMatchSnapshot()
})
